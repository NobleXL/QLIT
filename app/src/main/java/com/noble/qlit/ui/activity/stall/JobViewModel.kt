...
class JobViewModel : ViewModel() {
    ...
    var list = listOf(
        StallEntity(
            imageUrl = "https://cdn.staticaly.com/gh/NobleXL/Image-Hosting@main/NobleXL/NobleXL79340593bd269c43eb54a82008b0adc2.5o5ykylu3ww0.webp",
            title = "神里凌华",
            price = "${50000.0} 元",
